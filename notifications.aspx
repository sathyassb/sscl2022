<%@ Page Language="C#" AutoEventWireup="true" CodeFile="notifications.aspx.cs" MasterPageFile="~/MasterPage.master" Inherits="_Default" %>
   ...
   <section class="pages-top-bg" id="city">
        <div class="col-12">
            <div class="page-heading">
                <h2 class="featurette-heading">Notifications</h2>
            </div>
